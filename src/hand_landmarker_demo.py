...
def _print_model_error(model_path: Path) -> None:
    print(
        "\nMissing MediaPipe hand model file.\n"
        f"Expected: {model_path}\n\n"
        "Download the MediaPipe Hand Landmarker .task model and place it at "
        "models/hand_landmarker.task before running this demo.\n",
        file=sys.stderr,
    )
