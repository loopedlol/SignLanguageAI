...
TOTAL_FEATURES = POSE_SIZE + FACE_SIZE + LEFT_HAND_SIZE + RIGHT_HAND_SIZE
...
DEFAULT_INPUT_DIR = PROJECT_ROOT / "data" / "processed_landmarks"
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "data" / "normalized_landmarks"
